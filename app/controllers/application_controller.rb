...
class ApplicationController < ActionController::Base
    ...
    SKIP_COMMAND_CENTER_ACTIONS = ['create_default_guest_user', 'set_static_arrays', 'method_arrays', 
      'has_parent', 'has_children', 'setup_command_center_links', 
      'owners', 'staffs', 'products', 'service', 'on_demand_services']

      SKIP_ACTIONS_WITHOUT_OWNER = ['owners', 'stores', 'branches', 'staffs', 'products', 'services', 'property']
