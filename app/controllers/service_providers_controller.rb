...
class ServiceProvidersController < ApplicationController
  ...
  def service_provider_params
    params.require(:service_provider).permit(:user_id, :email, :phone_number, :email_verified,
                                             :phone_number_verified, :available, :online, :average_rating, :number_of_ratings, :currency, :bio, :location, :jobs_done, :total_earnings)
  end
end
