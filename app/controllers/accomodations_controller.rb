class AccomodationsController < ApplicationController
  ...
  private
    ...
    def accomodation_params
      params.require(:accomodation).permit(:owner_id, :description, :bathrooms, :bedrooms, :balcony, :location, :name, :price, :rating, :latitude, :longitude, :amenities, :currency, :max_guests, :min_stay, :max_stay, :guests_included, :extra_guest_fee, :cleaning_fee, :security_deposit, :service_fee, :host_fee, :cancellation_policy, :cancellation_days, :cancellation_penalty, :cancellation_rate)
    end
end
