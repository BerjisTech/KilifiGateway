...
class GovernmentFacilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create government_facility' do
    assert_difference('GovernmentFacility.count') do
      post government_facilities_url,
           params: { government_facility: { location: @government_facility.location, name: @government_facility.name,
                                            type: @government_facility.type } }
    end
  ...
  test 'should update government_facility' do
    patch government_facility_url(@government_facility),
          params: { government_facility: { location: @government_facility.location, name: @government_facility.name,
                                           type: @government_facility.type } }
