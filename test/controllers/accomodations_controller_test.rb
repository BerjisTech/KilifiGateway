...
class AccomodationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create accomodation" do
    assert_difference("Accomodation.count") do
      post accomodations_url, params: { accomodation: { balcony: @accomodation.balcony, bathrooms: @accomodation.bathrooms, bedrooms: @accomodation.bedrooms, description: @accomodation.description, location: @accomodation.location, owner_id: @accomodation.owner_id } }
    end
  ...
  test "should update accomodation" do
    patch accomodation_url(@accomodation), params: { accomodation: { balcony: @accomodation.balcony, bathrooms: @accomodation.bathrooms, bedrooms: @accomodation.bedrooms, description: @accomodation.description, location: @accomodation.location, owner_id: @accomodation.owner_id } }
