...
class AcceptedCurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create accepted_currency" do
    assert_difference("AcceptedCurrency.count") do
      post accepted_currencies_url, params: { accepted_currency: { code: @accepted_currency.code, code_three: @accepted_currency.code_three, conversion_rate: @accepted_currency.conversion_rate, country: @accepted_currency.country, name: @accepted_currency.name, value_against_dollar: @accepted_currency.value_against_dollar } }
    end
  ...
  test "should update accepted_currency" do
    patch accepted_currency_url(@accepted_currency), params: { accepted_currency: { code: @accepted_currency.code, code_three: @accepted_currency.code_three, conversion_rate: @accepted_currency.conversion_rate, country: @accepted_currency.country, name: @accepted_currency.name, value_against_dollar: @accepted_currency.value_against_dollar } }
