...
class WalletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallet" do
    assert_difference("Wallet.count") do
      post wallets_url, params: { wallet: { amount: @wallet.amount, conversion_rate: @wallet.conversion_rate, currency: @wallet.currency, user_id: @wallet.user_id } }
    end
  ...
  test "should update wallet" do
    patch wallet_url(@wallet), params: { wallet: { amount: @wallet.amount, conversion_rate: @wallet.conversion_rate, currency: @wallet.currency, user_id: @wallet.user_id } }
