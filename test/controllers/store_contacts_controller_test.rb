...
class StoreContactsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create store_contact" do
    assert_difference("StoreContact.count") do
      post store_contacts_url, params: { store_contact: { branch_id: @store_contact.branch_id, contact_info: @store_contact.contact_info, store_id: @store_contact.store_id } }
    end
  ...
  test "should update store_contact" do
    patch store_contact_url(@store_contact), params: { store_contact: { branch_id: @store_contact.branch_id, contact_info: @store_contact.contact_info, store_id: @store_contact.store_id } }
