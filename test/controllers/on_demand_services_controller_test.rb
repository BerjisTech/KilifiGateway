...
class OnDemandServicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create on_demand_service' do
    assert_difference('OnDemandService.count') do
      post on_demand_services_url,
           params: { on_demand_service: { description: @on_demand_service.description, name: @on_demand_service.name,
                                          service_provider_id: @on_demand_service.service_provider_id } }
    end
  ...
  test 'should update on_demand_service' do
    patch on_demand_service_url(@on_demand_service),
          params: { on_demand_service: { description: @on_demand_service.description, name: @on_demand_service.name,
                                         service_provider_id: @on_demand_service.service_provider_id } }
